...
@Service
public class XiaohongshuAccountRepositoryServiceImpl implements IXiaohongshuAccountRepositoryService {
    private static final String TABLE = "uploader_account_xiaohongshu";

    private final XiaohongshuAccountRepository repository;

    public XiaohongshuAccountRepositoryServiceImpl(XiaohongshuAccountRepository repository) {
    ...
    @Override
    public List<XiaohongshuAccountStatus> listAccounts() {
        return repository.query(
                ...
                LEFT JOIN uploader_account_xiaohongshu pa ON pa.topic = ua.topic
    ...
    public void saveStorageState(String topic, String userId, String nickname, String storageState) {
        repository.update(
                """
                INSERT INTO uploader_account_xiaohongshu (topic, user_id, nickname, storage_state_json, updated_at)
                VALUES (?, ?, ?, ?, NOW())
