...
public class ShipinhaoAccountRepositoryServiceImpl implements IShipinhaoAccountRepositoryService {
    ...
    public List<ShipinhaoAccountStatus> listAccounts() {
        return repository.query(
                ...
                LEFT JOIN uploader_account_shipinhao pa ON pa.topic = ua.topic
    ...
    public void saveStorageState(String topic, String userId, String nickname, String storageState) {
        repository.update(
                """
                INSERT INTO uploader_account_shipinhao (topic, user_id, nickname, storage_state_json, updated_at)
                VALUES (?, ?, ?, ?, NOW())
